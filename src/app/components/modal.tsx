...
function ModalComponent({ isModalOpen, onSubmit, handleClose }:ModalType) {
  ...
  const { handleSubmit, register, reset, formState: { isSubmitSuccessful } } = methods;
          ...
          <div className="px-4 py-6 sm:p-8">
            <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-3">
                <label htmlFor="plateName" className="block text-sm font-medium leading-6 text-gray-900">
                  Plate name
                </label>
                <div className="mt-2">
                  <input
                  ...
                  <input type='hidden' id="plateId" {...register("plateId")} value={uuidv4()} />
                </div>
              </div>

              <div className="col-span-full">
                <label htmlFor="plateType" className="block text-sm font-medium leading-6 text-gray-900">
                  Plate Type
                </label>
                <div className="mt-2">
                  <select
                  ...
                  className="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                    ...
                    <option value="96">96-well plate (12x8)</option>
                    <option value="384">384-well plate (24x16)</option>
                  </select>
                </div>
              </div>
            </div>
